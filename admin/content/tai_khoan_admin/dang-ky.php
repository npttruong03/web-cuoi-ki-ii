...
<body>
	...
	<?php
		...
		extract($_REQUEST);
		if(array_key_exists('btn_register1',$_REQUEST)){
			$mat_khau1 = md5($mat_khau);
			admin_insert($ma_ad,$ho_ten,$mat_khau1,$email,$dia_chi);

			echo '<script language="javascript">';
            echo 'alert("Đăng ký thành công")';
			echo '</script>';
			unset($ma_ad,$ho_ten,$mat_khau1,$email,$dia_chi);
			...
			<div class="wrap-login100">
				<form class="login100-form validate-form" method = "post">
					...
					<div class="container-login100-form-btn">
						<button class="login100-form-btn" type = "submit" name = "btn_register1">
							XÁC NHẬN
						</button>
					</div>
