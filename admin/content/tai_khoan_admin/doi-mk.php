...
<body>
	...
	<?php
		...
		extract($_REQUEST);
		if(array_key_exists('btn_change1',$_REQUEST)){
            if($mat_khau2 != $mat_khau3){
                ...
                if($user1){
                    if($user1['mat_khau'] == $mat_khau){
                        admin_change_password($ma_ad,$mat_khau2);
                        echo '<script language="javascript">';
			...
			<div class="wrap-login100">
				<form class="login100-form validate-form" method = "post">
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "Enter new password">
						<input class="input100" type="passwork" name="mat_khau2" placeholder="Mật khẩu mới" >
						<span class="focus-input100" data-placeholder="&#xf18e;"></span>
					</div>
					...
					<div class="container-login100-form-btn">
						<button class="login100-form-btn" type = "submit" name = "btn_change1">
							XÁC NHẬN
						</button>
					</div>
