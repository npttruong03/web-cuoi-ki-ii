...
<body>
	...
	<?php
        ...
        extract($_REQUEST);
        if(array_key_exists('btn_update1',$_REQUEST)){
            admin_update($ma_ad,$ho_ten,$mat_khau,$email,$dia_chi);
            $_SESSION['user1'] = admin_select_by_id($ma_ad);
		...
		if(array_key_exists('btn_logout1',$_REQUEST)){
			header('location: ./dang-xuat.php');
		}else if(array_key_exists('btn_admin1',$_REQUEST)){
			header('location: ./dang-xuat.php');
		}
	?>
			...
			<div class="wrap-login100">
				<form class="login100-form validate-form" method = "post">
					...
					<div class="wrap-input100 validate-input" data-validate = "Enter username">
						<input class="input100" type="text" name="ma_ad" placeholder="Username" value= "<?=$ma_ad?>" readonly>
						<span class="focus-input100" data-placeholder="&#xf18e;"></span>
					</div>

					<div class="wrap-input100 validate-input" data-validate="Enter fullname">
						<input class="input100" type="text" name="ho_ten_ad" placeholder="Fullname" value="<?=$ho_ten?>" readonly>
						<span class="focus-input100" class='fas' data-placeholder="&#xf18e;"></span>
					</div>

					<div class="wrap-input100 validate-input" data-validate="Enter password">
						<input class="input100" type="password" name="mat_khau_ad" placeholder="mat_khau" value = "<?=$mat_khau?>" readonly>
						<span class="focus-input100" data-placeholder="&#xf18e;"></span>
					</div>

                    <div class="wrap-input100 validate-input" data-validate="Enter email">
						<input class="input100" type="text" name="email_ad" placeholder="Email" value = "<?=$email?>" readonly>
						<span class="focus-input100" data-placeholder="&#xf18e;"></span>
					</div>

                    <div class="wrap-input100 validate-input" data-validate="Enter Address">
						<input class="input100" type="text" name="dia_chi_ad" placeholder="Address" value ="<?=$dia_chi?>" readonly>
						<span class="focus-input100" data-placeholder="&#xf18e;"></span>
					</div>
					...
					<button class="login100-form-btn" type = "submit" name = "btn_logout1">
							ĐĂNG XUẤT
						</button></a>&nbsp;&nbsp;
					<?php
						if($vai_tro == 1){
					?>
						<button class="login100-form-btn" type = "submit" name = "btn_admin1">
							ADMIN
						</button></a>
					<?php }?>
					</div>
