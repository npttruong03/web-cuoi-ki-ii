        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href=""><i class="fa fa-book"></i>Tin Tức</a>
                    </li>  
                        ...
                        <div class="page-header">
                            ...
                            <table class="table table-hover">
                                ...
                                <?php foreach($items as $item){ //lấy tt của mảng
                                  ...
                                  <tr>
                                    <td><?=$ma_tt?></td>
                                    <td><?=substr($chu_de,0,100)?><b> ...</b></td>
                                    <td><img src="../../../css/tin-tuc/img/<?=$hinh?>" alt="" style="width:80px;"></td>
                                    <td><?=substr($noi_dung,0,100)?><b> ...</b></td>
                                    <td> 
                            ...
                            <a href="./tin-tuc-new.php"><button class="btn btn-danger">Thêm mới</button></a>
                        </div>
		</div>
            </div>
         <!-- /. PAGE WRAPPER  -->
