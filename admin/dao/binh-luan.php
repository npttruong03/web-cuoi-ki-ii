<?php
    ...
    function binh_luan_select_by_tin_tuc($ma_tt){
        $sql = "SELECT b.*, h.ten_hh FROM binh_luan b JOIN tin_tuc h ON h.ma_tt=b.ma_tt WHERE b.ma_tt=? ORDER BY ngay_bl DESC";
