...
<body>
	...
	<?php
		...
		if(array_key_exists('btn_register',$_REQUEST)){
			...
			khach_hang_insert($ma_kh,$ho_ten,$mat_khau1,$email,$dia_chi);

			echo '<script language="javascript">';
            echo 'alert("Mời bạn đăng nhập để mua hàng !")';
			echo '</script>';
			
			unset($ma_kh,$ho_ten,$mat_khau1,$email,$dia_chi);
			...
			<div class="wrap-login100">
				<form class="login100-form validate-form" method = "post">
					...
					<div class="wrap-input100 validate-input" data-validate="Enter password">
						<input class="input100" type="password" name="ho_ten" placeholder="Họ và tên">
					...
					<div class="wrap-input100 validate-input" data-validate="Enter password">
						<input class="input100" type="password" name="dia_chi" placeholder="Địa chỉ">
						<span class="focus-input100" data-placeholder="&#xf18e;"></span>
					</div>
