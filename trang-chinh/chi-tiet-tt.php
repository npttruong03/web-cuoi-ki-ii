        ...
        <?php
            ...
            <!-- <div class="col-md-9"> -->
                <!-- <div class="thongtinsp">
                    <ul>
                        <li> -->
                            <h5 style="font-size: 30px;"><?=$chu_de?></h5>
                            <div class="col-md-8 container" style="padding-left: 0px">
                <div class="spchitiet">
                    <img src="../../bigshoes/css/tin-tuc/img/<?=$hinh?>" alt="" style="width:100%;">
                </div>
            </div>
                            <!-- <p> </p>
                        </li> -->
                        
                        <li style="margin-top: 15px;"><?=$noi_dung?></li>
        ...
        <div class="row">
            ...
            <?php
                ...
                if(array_key_exists("noi_dung",$_REQUEST)){
                    ...
                    binh_luan_insert($ma_kh, $ma_tt, $noi_dung, $ngay_bl);
                }
                $binh_luan_list = binh_luan_select_by_hang_hoa($ma_tt);
            ?>  
            <div class="binh-luan">
        ...
        <div class="row">
            ...
            <div class="col-md-12" style="padding-left: 0px;">
                ...
                <div class="owl-carousel owl-theme ">
                    ...
                    ?>
                    <div class="item">
                       <a href="chi-tiet-tt.php?ma_tt=<?=$ma_tt?>"><img style="width: 200px", height="150px" src="../../bigshoes/css/tin-tuc/img/<?=$hinh?>" alt="ds"><span class='cung-loai1'><?=$chu_de?></span></a>
                    </div>
                        <?php } ?>
                </div>
